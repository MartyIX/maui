...
#pragma warning restore CS0618 // Type or member is obsolete
		...
		void UpdatingGestureRecognizers()
		{
			...
			bool hasPointerGesture = gestures.HasAnyGesturesFor<PointerGestureRecognizer>();

			if (hasPointerGesture)
			{
				_subscriptionFlags |= SubscriptionFlags.ContainerPgrPointerEventsSubscribed;
				SubscribePointerGestureEvents(_container);
			}
		...
		void SubscribePointerGestureEvents(FrameworkElement container)
		{
